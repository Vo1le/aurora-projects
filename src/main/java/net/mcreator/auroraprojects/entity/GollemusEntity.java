...
import net.mcreator.auroraprojects.procedures.PanichalflifeProcedure;
...
public class GollemusEntity extends AuroraprojectsModElements.ModElement {
	...
	public GollemusEntity(AuroraprojectsModElements instance) {
		super(instance, 72);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GollemusRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6750208, -52480, new Item.Properties().group(BossItemGroup.tab))
				.setRegistryName("gollemus_spawn_egg"));
	}
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2, new PanicGoal(this, 1.5) {
				...
				public boolean shouldExecute() {
					...
					return super.shouldExecute() && PanichalflifeProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
							.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
				}
			});
			this.goalSelector.addGoal(3, new LookRandomlyGoal(this));
			this.goalSelector.addGoal(4, new LeapAtTargetGoal(this, (float) 1.2));
		}
