...
import net.mcreator.auroraprojects.entity.renderer.BbulletRenderer;
...
public class BbulletItem extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:bbullet")
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 5f, 10, 2);
