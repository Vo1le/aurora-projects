...
package net.mcreator.auroraprojects.particle;
...
public class AmiressablemouvantparticleParticle {
	...
	public static void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("amiressablemouvantparticle"));
	}
