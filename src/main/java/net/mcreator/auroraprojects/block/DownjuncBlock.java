...
public class DownjuncBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:downjunc")
	public static final Block block = null;
	public DownjuncBlock(AuroraprojectsModElements instance) {
		super(instance, 9);
	}
