...
public class MineraioratyotisBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:mineraioratyotis")
	public static final Block block = null;

	public MineraioratyotisBlock(AuroraprojectsModElements instance) {
		super(instance, 176);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mineraioratyotis");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("auroraprojects:mineraioratyotis_match"),
			...
			event.getRegistry().register(feature.setRegistryName("mineraioratyotis"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("auroraprojects:mineraioratyotis"), configuredFeature);
		}
	}
