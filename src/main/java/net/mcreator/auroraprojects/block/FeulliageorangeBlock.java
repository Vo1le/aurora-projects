...
public class FeulliageorangeBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:feulliageorange")
	public static final Block block = null;

	public FeulliageorangeBlock(AuroraprojectsModElements instance) {
		super(instance, 110);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("feulliageorange");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("auroraprojects:feulliageorange_match"),
			...
			event.getRegistry().register(feature.setRegistryName("feulliageorange"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("auroraprojects:feulliageorange"), configuredFeature);
		}
	}
