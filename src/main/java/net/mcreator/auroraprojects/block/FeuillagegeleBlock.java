...
public class FeuillagegeleBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:feuillagegele")
	public static final Block block = null;

	public FeuillagegeleBlock(AuroraprojectsModElements instance) {
		super(instance, 147);
	}
