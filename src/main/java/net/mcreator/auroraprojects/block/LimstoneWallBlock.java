...
public class LimstoneWallBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:limstone_wall")
	public static final Block block = null;

	public LimstoneWallBlock(AuroraprojectsModElements instance) {
		super(instance, 153);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.4000000000000001f, 6f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("limstone_wall");
		}
