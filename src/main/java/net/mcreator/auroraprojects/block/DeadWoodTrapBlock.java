...
public class DeadWoodTrapBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:dead_wood_trap")
	public static final Block block = null;

	public DeadWoodTrapBlock(AuroraprojectsModElements instance) {
		super(instance, 149);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_wood_trap");
		}
