...
public class BluePillarBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:blue_pillar")
	public static final Block block = null;

	public BluePillarBlock(AuroraprojectsModElements instance) {
		super(instance, 89);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).harvestLevel(3)
					.harvestTool(ToolType.AXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("blue_pillar");
		}
