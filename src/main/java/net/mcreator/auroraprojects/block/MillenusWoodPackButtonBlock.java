...
public class MillenusWoodPackButtonBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:millenus_wood_pack_button")
	public static final Block block = null;
	public MillenusWoodPackButtonBlock(AuroraprojectsModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("millenus_wood_pack_button");
		}
