...
public class YiviaFlowerBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:yivia_flower")
	public static final Block block = null;

	public YiviaFlowerBlock(AuroraprojectsModElements instance) {
		super(instance, 91);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("yivia_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("auroraprojects:yivia_flower"), configuredFeature);
		}
	}
