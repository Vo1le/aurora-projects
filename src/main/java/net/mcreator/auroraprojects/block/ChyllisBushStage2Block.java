...
public class ChyllisBushStage2Block extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:chyllis_bush_stage_2")
	public static final Block block = null;

	public ChyllisBushStage2Block(AuroraprojectsModElements instance) {
		super(instance, 93);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("chyllis_bush_stage_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("auroraprojects:chyllis_bush_stage_2"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("chyllis_bush_stage_2");
		}
