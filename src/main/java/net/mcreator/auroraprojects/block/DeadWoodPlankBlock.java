...
public class DeadWoodPlankBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:dead_wood_plank")
	public static final Block block = null;

	public DeadWoodPlankBlock(AuroraprojectsModElements instance) {
		super(instance, 155);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dead_wood_plank");
		}
