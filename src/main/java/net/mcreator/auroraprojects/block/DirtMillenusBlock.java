...
public class DirtMillenusBlock extends AuroraprojectsModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("auroraprojects:dirt_millenus_match"),
			...
			event.getRegistry().register(feature.setRegistryName("dirt_millenus"));
