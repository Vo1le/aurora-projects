...
public class SperaziteStairsBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:sperazite_stairs")
	public static final Block block = null;

	public SperaziteStairsBlock(AuroraprojectsModElements instance) {
		super(instance, 100);
	}
