...
public class BlueShroomLightBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:blue_shroom_light")
	public static final Block block = null;

	public BlueShroomLightBlock(AuroraprojectsModElements instance) {
		super(instance, 116);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_shroom_light");
		}
