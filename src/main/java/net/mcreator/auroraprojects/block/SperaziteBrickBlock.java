...
public class SperaziteBrickBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:sperazite_brick")
	public static final Block block = null;

	public SperaziteBrickBlock(AuroraprojectsModElements instance) {
		super(instance, 98);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sperazite_brick");
		}
