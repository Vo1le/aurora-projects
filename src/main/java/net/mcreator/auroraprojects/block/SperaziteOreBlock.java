...
public class SperaziteOreBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:sperazite_ore")
	public static final Block block = null;

	public SperaziteOreBlock(AuroraprojectsModElements instance) {
		super(instance, 97);
	}
