...
public class RedusVineBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:redus_vine")
	public static final Block block = null;

	public RedusVineBlock(AuroraprojectsModElements instance) {
		super(instance, 105);
	}
