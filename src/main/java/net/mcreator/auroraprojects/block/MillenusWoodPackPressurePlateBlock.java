...
public class MillenusWoodPackPressurePlateBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:millenus_wood_pack_pressure_plate")
	public static final Block block = null;
	public MillenusWoodPackPressurePlateBlock(AuroraprojectsModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("millenus_wood_pack_pressure_plate");
		}
