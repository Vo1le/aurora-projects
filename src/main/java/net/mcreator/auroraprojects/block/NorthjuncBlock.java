...
public class NorthjuncBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:northjunc")
	public static final Block block = null;

	public NorthjuncBlock(AuroraprojectsModElements instance) {
		super(instance, 10);
	}
