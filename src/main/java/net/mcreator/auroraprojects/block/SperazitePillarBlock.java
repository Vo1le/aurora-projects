...
public class SperazitePillarBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:sperazite_pillar")
	public static final Block block = null;

	public SperazitePillarBlock(AuroraprojectsModElements instance) {
		super(instance, 101);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sperazite_pillar");
		}
