...
public class EstroleFlowerBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:estrole_flower")
	public static final Block block = null;

	public EstroleFlowerBlock(AuroraprojectsModElements instance) {
		super(instance, 90);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("estrole_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("auroraprojects:estrole_flower"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("estrole_flower");
		}
