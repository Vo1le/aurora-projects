...
public class AtyotisRockBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:atyotis_rock")
	public static final Block block = null;

	public AtyotisRockBlock(AuroraprojectsModElements instance) {
		super(instance, 88);
	}
