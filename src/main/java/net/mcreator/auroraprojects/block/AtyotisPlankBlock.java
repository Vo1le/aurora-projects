...
public class AtyotisPlankBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:atyotis_plank")
	public static final Block block = null;

	public AtyotisPlankBlock(AuroraprojectsModElements instance) {
		super(instance, 115);
	}
