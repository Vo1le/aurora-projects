...
public class CreeperedAtyotisStoneBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:creepered_atyotis_stone")
	public static final Block block = null;

	public CreeperedAtyotisStoneBlock(AuroraprojectsModElements instance) {
		super(instance, 111);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("creepered_atyotis_stone");
		}
