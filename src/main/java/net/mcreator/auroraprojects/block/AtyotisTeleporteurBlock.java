...
public class AtyotisTeleporteurBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:atyotis_teleporteur")
	public static final Block block = null;

	public AtyotisTeleporteurBlock(AuroraprojectsModElements instance) {
		super(instance, 130);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			AtyotisTeleporteurLorsDunClicDroitSurLeBlocProcedure.executeProcedure(Stream
