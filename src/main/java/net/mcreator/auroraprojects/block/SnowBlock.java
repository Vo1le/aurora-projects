...
public class SnowBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:snow")
	public static final Block block = null;

	public SnowBlock(AuroraprojectsModElements instance) {
		super(instance, 156);
	}
