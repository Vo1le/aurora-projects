...
public class AtyotisDoorBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:atyotis_door")
	public static final Block block = null;

	public AtyotisDoorBlock(AuroraprojectsModElements instance) {
		super(instance, 109);
	}
