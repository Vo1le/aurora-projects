...
public class HerbedeMillenusBlock extends AuroraprojectsModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("auroraprojects:herbede_millenus_match"),
			...
			event.getRegistry().register(feature.setRegistryName("herbede_millenus"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("auroraprojects:herbede_millenus"), configuredFeature);
		}
	}
	@SubscribeEvent
