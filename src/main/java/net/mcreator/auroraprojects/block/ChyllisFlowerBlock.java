...
public class ChyllisFlowerBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:chyllis_flower")
	public static final Block block = null;

	public ChyllisFlowerBlock(AuroraprojectsModElements instance) {
		super(instance, 92);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("chyllis_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("auroraprojects:chyllis_flower"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("chyllis_flower");
		}
