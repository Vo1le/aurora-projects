...
public class PurpleShroomLightBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:purple_shroom_light")
	public static final Block block = null;

	public PurpleShroomLightBlock(AuroraprojectsModElements instance) {
		super(instance, 117);
	}
