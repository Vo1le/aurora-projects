...
public class AbraisiePlanteBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:abraisie_plante")
	public static final Block block = null;

	public AbraisiePlanteBlock(AuroraprojectsModElements instance) {
		super(instance, 94);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("abraisie_plante"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("auroraprojects:abraisie_plante"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("abraisie_plante");
		}
