...
import net.mcreator.auroraprojects.gui.MalgortpGui;
...
public class MalgorkteleporteurBlock extends AuroraprojectsModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("malgorkteleporteur");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Malgork téléporteur");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new MalgortpGui.GuiContainerMod(id, inventory,
