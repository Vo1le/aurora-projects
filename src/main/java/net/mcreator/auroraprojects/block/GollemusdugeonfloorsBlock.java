...
public class GollemusdugeonfloorsBlock extends AuroraprojectsModElements.ModElement {
	@ObjectHolder("auroraprojects:gollemusdugeonfloors")
	public static final Block block = null;

	public GollemusdugeonfloorsBlock(AuroraprojectsModElements instance) {
		super(instance, 74);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gollemusdugeonfloors");
		}
