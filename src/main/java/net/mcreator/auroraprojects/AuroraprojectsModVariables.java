package net.mcreator.auroraprojects;
...
public class AuroraprojectsModVariables {
	public AuroraprojectsModVariables(AuroraprojectsModElements elements) {
	...
	public void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
		if (!event.getPlayer().world.isRemote()) {
			...
			if (mapdata != null)
				AuroraprojectsMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayerEntity) event.getPlayer()),
	...
	public static class MapVariables extends WorldSavedData {
		...
		@Override
		public void read(CompoundNBT nbt) {
			pistorlingame = nbt.getDouble("pistorlingame");
		}

		@Override
		public CompoundNBT write(CompoundNBT nbt) {
			nbt.putDouble("pistorlingame", pistorlingame);
			return nbt;
		}
