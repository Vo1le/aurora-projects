...
package net.mcreator.auroraprojects.world.structure;
...
public class Arbreprintemp1Structure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 500000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("auroraprojects", "arbeprimtemps1"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("arbreprintemp_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("auroraprojects:arbreprintemp_1"), configuredFeature);
		}
	}
	...
	public static void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("auroraprojects:printempsde_millenus").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
