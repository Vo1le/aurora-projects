...
public class AutomneMillenusBiome extends AuroraprojectsModElements.ModElement {
	public static Biome biome;

	public AutomneMillenusBiome(AuroraprojectsModElements instance) {
		super(instance, 117);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("auroraprojects:automne_millenus"));
			}
		}
	}
