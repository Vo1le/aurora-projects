...
public class BiomeForetMillenusBiome extends AuroraprojectsModElements.ModElement {
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration(
								(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(MillenusWoodPackLogBlock.block.getDefaultState()),
										new SimpleBlockStateProvider(MillenusWoodPackWoodBlock.block.getDefaultState()),
										new BlobFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(0), 3),
										new StraightTrunkPlacer(18, 2, 0), new TwoLayerFeature(1, 0, 1)))
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("biome_foret_millenus_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
