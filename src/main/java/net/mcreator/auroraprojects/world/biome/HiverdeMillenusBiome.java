...
public class HiverdeMillenusBiome extends AuroraprojectsModElements.ModElement {
	public static Biome biome;

	public HiverdeMillenusBiome(AuroraprojectsModElements instance) {
		super(instance, 157);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-3355444).withGrassColor(-1).build();
				...
				event.getRegistry().register(biome.setRegistryName("auroraprojects:hiverde_millenus"));
			}
		}
	}
