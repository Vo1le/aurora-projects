...
import net.mcreator.auroraprojects.block.AtyotisGrassBlock;
...
public class AtyotisB1Biome extends AuroraprojectsModElements.ModElement {
	public static Biome biome;

	public AtyotisB1Biome(AuroraprojectsModElements instance) {
		super(instance, 107);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(GrimBarkBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(AtyotisLeaveBlock.block.getDefaultState()),
				...
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(BlueEntity.entity, 5, 1, 2));
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(GrenouilleEntity.entity, 16, 2, 5));
				...
				event.getRegistry().register(biome.setRegistryName("auroraprojects:atyotis_b_1"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("atyotis_b_1_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("atyotis_b_1_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("atyotis_b_1_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
